      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            <a class="nav-item nav-link" href="staffindex.php">STAFF HOME</a>
          </div>
        ...
        <div class="col-sm-3">
            <div class="contact_main">
                <input type="text" class="mail_text" placeholder="FIRST NAME" name="firstname"> 
                  <input type="text" class="mail_text" placeholder="SECOND NAME" name="secondname">
                  <p>  _   </p>
                <input type="search" class="btn btn-danger" name="search" value="SEARCH">
            </div>
        </div>
      <!-- header section end -->
