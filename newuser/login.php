   ...
   <?php
      ...
      if(isset($_POST["login"]))
      {
        ...
        if($result)
        {
            ...
            {
              echo "Accoount Found " . $data['FirstName'] . ".";
            }
        }
        else
        {
        ...
        <div class="col-md-6">
          <div class="mail_section">
            <FORM action="login.php" method="post">
              <input type="email" class="mail_text" placeholder="Email" name="useremail" required>
              <input type="password" class="mail_text" placeholder="Password" name="userpasswd" required>
...
<!-- log in section end -->
      ...
      <div class="copyright_section">
        <div class="container">
          <p class="copyright_text">Copyright 2019 All Right Reserved By group 2</a></p>
        </div>
      </div>
